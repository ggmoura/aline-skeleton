package br.com.alinesoftware.filter;
...
import br.com.alinesoftware.config.HttpModifiedSinceRequestWrapper;
...
public class HttpIfModifiedSinceFix implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, 
																									 ServletException {
		logger.entering(_CLASS,	"doFilter(ServletRequest,ServletResponse,FilterChain)",
